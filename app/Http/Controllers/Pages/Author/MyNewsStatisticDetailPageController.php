...
class MyNewsStatisticDetailPageController extends Controller
{
    public function index($no)
    {
        ...
        if ($data["news"]["author"]["no"] != Session::get("userData.no")) {
        ...
        return view("author.pages.my_news_statistic_detail")->with("data", $data);
    }
}
