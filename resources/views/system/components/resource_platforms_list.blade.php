                ...
                <div class="listingTypeSelect">
                    <form method="POST" class="outSelectBox">
                        ...
                        <select name="listingType" onchange="if(this.value != 0) { this.form.submit(); }">
                            <option value="default" @if (Route::is('kaynak_siteler')) selected @endif>Varsayılan
                            </option>
                            ...
                            <option value="websiteLinkAZ" @if (Route::is('kaynak_siteler_websiteLinkAZ')) selected @endif>Site Linki
                                (A - Z)</option>
                            <option value="websiteLinkZA" @if (Route::is('kaynak_siteler_websiteLinkZA')) selected @endif>Site Linki
                                (Z - A)</option>
                            <option value="linkUrlAZ" @if (Route::is('kaynak_siteler_linkUrlAZ')) selected @endif>Link Metni (A -
                                Z)</option>
                            <option value="linkUrlZA" @if (Route::is('kaynak_siteler_linkUrlZA')) selected @endif>Link Metni (Z -
                                A)</option>
                        </select>
                    </form>
                </div>
