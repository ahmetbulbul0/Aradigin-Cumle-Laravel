    ...
    <div class="inDbList">
        <div class="outTitle">
            ...
            <div class="titleSelects">
                <div class="actions">
                    <a href="{{ route('kategori_tipi_ekle') }}" target="blank">Yeni Kategori Tipi Oluştur</a>
                </div>
            ...
            @foreach ($data['data'] as $item)
                <div class="line">
                    ...
                    <div class="actions w20">
                        <span>
                            <a href="/sistem-paneli/kategori-tipi/düzenle/{{ $item['no'] }}">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="/sistem-paneli/kategori-tipi/sil/{{ $item['no'] }}">
